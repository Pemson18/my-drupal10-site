...
class __TwigTemplate_666bcf4ecef970a324faada601904ace extends Template
{
    private $source;
    private $macros = [];
...
($context["empty"] ?? null)) {
            // line 78
            echo "      ";
            $this->loadTemplate("@radix/views/views-view.twig", "@radix/views/views-view.twig", 78, "91993213")->display(twig_array_merge($context, ["type" => "warning", "heading" => false, "content" =>             // line 81
($context["empty"] ?? null), "alert_utility_classes" => [0 => "view-empty"]]));
    ...
    {
        return new Source("", "@radix/views/views-view.twig", "themes/contrib/radix/src/components/views/views-view.twig");
    }
...
/* @radix/views/views-view.twig */
class __TwigTemplate_666bcf4ecef970a324faada601904ace___91993213 extends Template
{
    private $source;
    private $macros = [];
