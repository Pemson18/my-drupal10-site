...
class __TwigTemplate_5e553c6c35011af7ae56b1ed5df7beeb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            if (($context["image"] ?? null)) {
                // line 30
                echo "      ";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_call_macro($macros["navbar_brand"], "macro_image", [($context["image"] ?? null), ($context["width"] ?? null), ($context["height"] ?? null), ($context["alt"] ?? null)], 30, $context, $this->getSourceContext()));
                echo "
    ";
            }
            // line 32
...
";
    ...
    public function macro_image($__src__ = null, $__width__ = null, $__height__ = null, $__alt__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 37
            echo "  ";
            $context["height_attr"] = (((($context["height"] ?? null) != "auto")) ? ((("height=\"" . $this->sandbox->ensureToStringAllowed(($context["height"] ?? null), 37, $this->source)) . "\"")) : (""));
            // line 38
            echo "
  <img src=\"";
            // line 39
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["src"] ?? null), 39, $this->source), "html", null, true);
            echo "\" width=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("width", $context)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["width"] ?? null), 39, $this->source), 30)) : (30)), "html", null, true);
            echo "\" ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["height_attr"] ?? null), 39, $this->source), "html", null, true);
            echo " alt=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("alt", $context)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["alt"] ?? null), 39, $this->source), "")) : ("")), "html", null, true);
            echo "\" class=\"me-2\" />
";
    ...
    {
        return array (  121 => 39,  118 => 38,  115 => 37,  99 => 36,  94 => 35,  87 => 32,  81 => 30,  79 => 29,  72 => 28,  65 => 25,  59 => 23,  57 => 22,  48 => 21,  46 => 20,  43 => 19,  41 => 18,  39 => 17,);
    }

    public function getSourceContext()
    {
        return new Source("", "@radix/navbar/navbar-brand.twig", "themes/contrib/radix/src/components/navbar/navbar-brand.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("import" => 17, "set" => 18, "if" => 20, "macro" => 36);
        static $filters = array("join" => 18, "escape" => 21, "default" => 39);
